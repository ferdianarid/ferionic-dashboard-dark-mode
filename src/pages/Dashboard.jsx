...
const Dashboard = () => {
    ...
    return (
        <React.Fragment>
            <aside className="ml-[-100%] dark:bg-gray-800 dark:text-white fixed overflow-y-scroll z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white dark:border-gray-200 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
                <div>
                    <div className="-mx-6 px-6 py-4">
                        <button alt="links" href="#" title="home">
                            <img src={ferionic} className="w-32" alt="ferionic" />
                        </button>
                    </div>

                    <div className="mt-8 text-center">
                        <img src={photo} alt="" className="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28" />
                        <h5 className="hidden mt-4 text-xl dark:text-white font-semibold text-gray-600 lg:block">Ferdian Ahmad R</h5>
                        <span className="hidden text-gray-400 lg:block dark:text-gray-400" > Frontend Engineer</span >
                    </div >

                    <ul className="space-y-2 tracking-wide mt-8" >
                        <li>
                            <button alt="links" href="#" aria-label="dashboard" className="w-full relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
                                <svg className="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
                                    <path d="M6 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8ZM6 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1Z" className="fill-current text-cyan-400 dark:fill-slate-600"></path>
                                    <path d="M13 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V8Z" className="fill-current text-cyan-200 group-hover:text-cyan-300" ></path >
                                    <path d="M13 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-1Z" className="fill-current group-hover:text-sky-300" ></path >
                                </svg >
                                <span className="-mr-1 dark:text-white font-medium" > Dashboard</span >
                            </button >
                        </li >
                        <li>
                            <button alt="links" href="#" className="w-full px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                                ...
                                <span className="group-hover:text-gray-700 dark:text-white" > Categories</span >
                            </button >
                        </li >
                        <li>
                            <button alt="links" href="#" className="w-full px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                                ...
                                <span className="group-hover:text-gray-700 dark:text-white" > Reports</span >
                            </button >
                        </li >
                        <li>
                            <button alt="links" href="#" className="w-full px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                                ...
                                <span className="group-hover:text-gray-700 dark:text-white" > Other data</span >
                            </button >
                        </li >
                        <li>
                            <button alt="links" href="#" className="w-full px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                                ...
                                <span className="group-hover:text-gray-700 dark:text-white" > Finance</span >
                            </button >
                        </li >
                    </ul >
                </div >

                <div className="px-6 -mx-6 pt-4 flex justify-between items-center border-t dark:border-gray-200" >
                    <button className="w-full px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group" >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                        </svg >
                        <span className="group-hover:text-gray-700 dark:text-white" > Logout</span >
                    </button >
                </div >
            </aside >
            {open ? <Sidebar setOpen={setOpen} /> : null}
            <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]" >
                <div className="sticky z-10 top-0 h-16 border-b dark:border-gray-200 dark:bg-gray-800 bg-white dark:text-white lg:py-2.5" >
                    <div className="px-6 flex items-center justify-between space-x-4 2xl:container" >
                        <h5 hidden className="text-2xl text-gray-600 dark:text-white font-medium lg:block" > Dashboard</h5 >
                        <Toggle addclass={"hidden lg:block"} />
                        <button className="w-12 h-16 -mr-2 border-r lg:hidden" >
                            <svg onClick={() => setOpen(!open)} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 my-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
                        ...
                        <div className="flex space-x-4" >
                            <div hidden className="md:block" >
                                <div className="relative flex  items-center text-gray-400 focus-within:text-cyan-400" >
                                    ...
                                    <input type="search" name="leadingIcon" id="leadingIcon" placeholder="Search here" className="w-full dark:bg-gray-700 pl-14 pr-4 py-2.5 rounded-xl text-sm text-gray-600 outline-none border border-gray-300 focus:border-cyan-300 transition" />
                                </div >
                            </div >
                            <button aria-label="search" className="w-10 h-10 rounded-xl border bg-gray-100 dark:bg-gray-700 md:hidden" >
                                <svg xmlns="http://ww50w3.org/2000/svg" className="w-4 mx-auto fill-current text-gray-600" viewBox="0 0 35.997 36.004" >
                                    <path id="Icon_awesome-search" data-name="search" d="M35.508,31.127l-7.01-7.01a1.686,1.686,0,0,0-1.2-.492H26.156a14.618,14.618,0,1,0-2.531,2.531V27.3a1.686,1.686,0,0,0,.492,1.2l7.01,7.01a1.681,1.681,0,0,0,2.384,0l1.99-1.99a1.7,1.7,0,0,0,.007-2.391Zm-20.883-7.5a9,9,0,1,1,9-9A8.995,8.995,0,0,1,14.625,23.625Z"></path>
                                </svg >
                            </button >
                            <button aria-label="chat" className="w-10 h-10 rounded-xl border bg-gray-100 dark:bg-gray-700" >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 m-auto text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                                </svg >
                            </button >
                            <button aria-label="notification" className="w-10 h-10 rounded-xl border bg-gray-100 dark:bg-gray-700" >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 m-auto text-gray-200" viewBox="0 0 20 20" fill="currentColor" >
                ...
                <div className="dark:bg-gray-800 bg-white px-6 py-6 2xl:container" >
