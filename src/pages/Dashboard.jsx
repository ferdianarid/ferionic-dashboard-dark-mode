            ...
            <aside class="ml-[-100%] fixed overflow-y-scroll z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
                <div>
                    ...
                    <ul class="space-y-2 tracking-wide mt-8">
                        <li>
                            <button alt="links" href="#" aria-label="dashboard" class="w-full relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
                        ...
                        <li>
                            <button alt="links" href="#" class="w-full px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                ...
                <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
                    <button class="w-full px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                ...
                <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
                    <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
                        ...
                        <button class="w-12 h-16 -mr-2 border-r lg:hidden">
                            <svg onClick={() => setOpen(!open)} xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 my-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
